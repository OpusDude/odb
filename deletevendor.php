...
<?php
    ...
    { 
        ...
        {
            $sql = "DELETE FROM Vendor WHERE Id = '$rec_id'";
    
            if ($conn->query($sql) === TRUE)
            {
                $message = "Vendor '" .$_POST['Vendor']. "' successfully deleted from database";
            }
            else 
            {
      ...
      <div class="container">
         ...
         <form id="delete_form" method="POST" action="<?php echo $_SERVER['PHP_SELF']; ?>?id=<?php echo $rec_id; ?>">
          <table width="400" style="border:1px solid silver" cellpadding="5" cellspacing="0" align="center" border="1">
            <tr>
              <td colspan="2" style="background:#6495ED; color:#FFFFFF; font-size:20px" align="center">Delete Vendor</td>
            </tr>
            <?php
            $sql    = "SELECT * FROM Vendor WHERE Id = '$rec_id'";
            ...
            if ( $result->num_rows > 0 ) 
            {
               ...
               {
                  echo "<tr>\n";
                  echo "             <td colspan=\"1\" align=\"center\"><b>Vendor:</b></td>\n";
                  echo "             <td colspan=\"1\" align=\"center\"><input type=\"hidden\" name=\"Vendor\" value=\"".$row['Vendor']."\">".$row['Vendor']."</td>\n";
                  echo "            </tr>\n";
                }
            }
            ?>
